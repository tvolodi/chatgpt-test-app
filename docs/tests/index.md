...
|---------------|------------|----------------------------------------|--------------------|--------------------------|-----------------------------------------------|
| TC-UI-001     | ui         | Landing page structure and nav         | MOD-FE-Landing     | REQ-001                  | TC-UI-001.landing-structure.md                |
| TC-UI-002     | ui         | Landing SEO and metadata               | MOD-FE-Landing     | REQ-001                  | TC-UI-002.landing-seo.md                      |
| TC-UI-003     | ui         | Landing news/articles fixtures         | MOD-FE-Landing     | REQ-001                  | TC-UI-003.landing-content-feeds.md            |
| TC-UI-004     | perf       | Landing performance and ISR freshness  | MOD-FE-Landing     | REQ-001                  | TC-UI-004.landing-performance.md              |
